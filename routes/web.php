...
Route::prefix('admin')->name('admin.transaction.')->middleware('auth')->group(function () {
    ...
    Route::get('/transaction/{uuid}/print', 
...
Route::prefix('admin')->name('admin.maintenance.')->middleware('auth')->group(function () {
    Route::get('/maintenance', [MaintenanceController::class, 'index'])->name('index');
    Route::post('/maintenance', [MaintenanceController::class, 'store'])->name('store')->middleware('admin');
    Route::put('/maintenance/{uuid}', [MaintenanceController::class, 'update'])->name('update')->middleware('admin');
    Route::delete('/maintenance/{uuid}', [MaintenanceController::class, 'destroy'])->name('destroy')->middleware('admin');
